...
public static class PlotErrors
{
    ...
    public static Error PlotDoesntBelongToProducer => new("Plot.PlotDoesntBelongToProducer", "The plot doesn't belong to the producer.");
    public static Error ForbbidenOperation => new("Plot.ForbbidenOperation", "The operation is not allowed for this plot.");
}
